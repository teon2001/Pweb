    ...
    public partial class InitialCreate_update : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ingredient_Food", x => new { x.FoodId, x.IngredientId });
                    table.ForeignKey(
                        name: "FK_Ingredient_Food_Food_FoodId",
                        column: x => x.FoodId,
                        principalTable: "Food",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Ingredient_Food_Ingredients_IngredientId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ingredient_Food_IngredientId",
